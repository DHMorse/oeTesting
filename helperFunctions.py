...
from globalVars import EXCEPTION_OUTPUT_FILE_LOCATION, tests
...
async def testLoginMessage(TESTING_CHANNEL, rewardType: str, amount: int, daysLoggedInInARow: int, testContext: str, 
    ...
    async for message in TESTING_CHANNEL.history(limit=2):
        if index == 0:
            ...
            elif rewardType == 'card':
                message0ToCheck = None
            else:
