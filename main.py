...
''')
    ...
    try:    
        ...
        tests.append({11: {'passed': False, 'expectedResult': 1, 'actualResult': f'Exception: {e}', 'test': 'daysLoggedInInARow After Login'}})
    ...
    try:
        ...
        tests.append({12: {'passed': False, 'expectedResult': not None, 'actualResult': f'Exception: {e}', 'test': 'lastLogin After Login'}})
    ...
    try:
        ...
        tests.append({13: {'passed': False, 'expectedResult': 0, 'actualResult': f'Exception: {e}', 'test': 'money After Login'}})
    ...
    try:
        ...
        tests.append({14: {'passed': False, 'expectedResult': 0, 'actualResult': f'Exception: {e}', 'test': 'userId After Login'}})
    ...
    try:
        ...
        tests.append({15: {'passed': False, 'expectedResult': 'john5971', 'actualResult': f'Exception {e}', 'test': 'username After Login'}})
    ...
    try:
        ...
        tests.append({16: {'passed': False, 'expectedResult': 13, 'actualResult': f'Exception: {e}', 'test': 'xp After Login'}})
    ...
    async for message in TESTING_CHANNEL.history(limit=1):
        try:
            ...
            tests.append({18: {'passed': False, 'expectedResult': 'Image', 'actualResult': f'Exception: {e}', 'test': 'Generated Card'}})
